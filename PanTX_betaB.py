...
class PanTX_betaB(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "OFDM (bpsk,bpsk)")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("OFDM (bpsk,bpsk)")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PanTX_betaB")
...
def main(top_block_cls=PanTX_betaB, options=None):
