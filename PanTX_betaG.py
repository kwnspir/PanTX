...
class PanTX_betaG(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PanTX_betaG")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PanTX_betaG")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PanTX_betaG")
...
def main(top_block_cls=PanTX_betaG, options=None):
