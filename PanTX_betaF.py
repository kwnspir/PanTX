...
class PanTX_betaF(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PanTX_betaF")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PanTX_betaF")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PanTX_betaF")
...
def main(top_block_cls=PanTX_betaF, options=None):
