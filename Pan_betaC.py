...
class Pan_betaC(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PanTX_betaC")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PanTX_betaC")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Pan_betaC")
...
def main(top_block_cls=Pan_betaC, options=None):
