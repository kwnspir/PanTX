...
class PanTX_betaD(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "PanTX_betaD")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("PanTX_betaD")
        ...
        self.settings = Qt.QSettings("GNU Radio", "PanTX_betaD")
...
def main(top_block_cls=PanTX_betaD, options=None):
